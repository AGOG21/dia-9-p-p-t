...
function iniciarJuego(opcion){
    ...
    //resultado
    if (comp ==1) {
        resultadoJuego.innerHTML = " escogiste =  "+movUsuario + "<br> el bot eligio =  "+ movPC+ "<br> <span class='ganador'>GANASTE</span>";
    }
    if (comp ==2) {
        resultadoJuego.innerHTML = " escogiste =  "+movUsuario + "<br> el bot eligio =  "+ movPC+ "<br> <span class='perdedor'>PERDISTE</span>";
    }
    if (comp ==3) {
        resultadoJuego.innerHTML = " escogiste =  "+movUsuario + "<br> el bot eligio =  "+ movPC+ "<br> <span class='empate'>EMPATE</span>";
    }
}
